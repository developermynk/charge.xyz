...
/**
 * Deploy the token. Bytecode is supplied by the caller (fetched from our own
 * API route, which serves the compiled artifact) so the browser never compiles
 * Solidity and the deployed bytecode is auditable and identical for everyone.
 */
