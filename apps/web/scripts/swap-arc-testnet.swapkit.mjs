// Swap USDC -> EURC on Arc_Testnet using Circle Swap Kit + Circle Wallets adapter.
// (Standalone swap-only SDK; no App Kit install required.)
//
// SECURITY NOTES:
...
//
// Run from apps/web:
//   node scripts/swap-arc-testnet.swapkit.mjs
//
...
console.log("=== Swap plan (Swap Kit) ===");
